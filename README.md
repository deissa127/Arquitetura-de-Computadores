...
3. Visão do Programador sobre a Memória
Embora a parte física (chips e barramentos) pertença à organização, na arquitetura estuda-se a hierarquia de memória e o espaço de endereçamento. Isso inclui entender como o processador "enxerga" a memória principal e como ele gerencia a execução de instruções através de contadores de programa (PC) e ponteiros de pilha (SP).

> Essa disciplina é fundamental para que o aluno entenda o impacto direto que as decisões de design do hardware têm na eficiência e na performance do software que será desenvolvido ao longo do curso.