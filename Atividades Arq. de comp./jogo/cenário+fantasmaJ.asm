...
loop_copia:
	...
	addi $11, $11, 4      # Avança +4 leitura
	addi $12, $12, 4      # Avança +4 escrita
...
# Inicializa as posições oficiais dos fantasmas (endereço real na tela)
	addi $s0, $5, 0x34D0	# Fantasma 1 (Rosa)
	addi $s1, $5, 0x34EC	# Fantasma 2 (Vermelho)
	
	# Inicializa as direções iniciais de cada um (1=Cima, 2=Baixo, 3=Esquerda, 4=Direita)
	li $s2, 1		# Fantasma 1 começa indo para a Direita
	li $s3, 1		# Fantasma 2 começa indo para Cima
